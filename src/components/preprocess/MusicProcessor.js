    ...
    <div className="music-processor">
      ...
      <div className="d-flex w-100 gap-2">
        ...
        >
          ...
          <p style={{fontSize: '12px'}} className="m-0">Preprocess your music code</p>
        </button>
        <button
          id="process_play"
          className="btn btn-outline-secondary d-flex w-100 flex-column align-items-start p-3 text-start"
        >
          <div className="d-flex gap-2 w-100 justify-content-between align-items-start mb-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-square-play-icon lucide-square-play"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 9.003a1 1 0 0 1 1.517-.859l4.997 2.997a1 1 0 0 1 0 1.718l-4.997 2.997A1 1 0 0 1 9 14.996z"/></svg>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <p style={{fontSize: '12px'}} className="m-0">Process and play your music code</p>
        </button>
      </div>
    </div>
  );
